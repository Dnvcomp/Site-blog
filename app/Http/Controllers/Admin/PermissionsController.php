...
use Dnvcomp\Repositories\PermissionsRepository;
...
class PermissionsController extends AdminController
{
    ...
    public function __construct(PermissionsRepository $per_rep, RolesRepository $rol_rep)
    {
        ...
        $this->template = env('DNVCOMP').'.admin.permissions';
    }
    ...
    public function index()
    {
        ...
        $this->content = view(env('DNVCOMP').'.admin.permissions_content')->with(['roles'=>$roles,'priv'=>$permissions])->render();
